    ...
    where TMonthlyEconometricIndex : MonthlyEconometricIndex<TMonthlyEconometricIndex>
{
...

    {
        ...
        return this switch
        {
            AverageElectricEnergyProductionPrice _ =>
                new AverageElectricEnergyProductionPrice(amount, remark, until, identityFactory) as TMonthlyEconometricIndex,
            NaturalGasSellingPrice _ =>
                new NaturalGasSellingPrice(amount, remark, until, identityFactory) as TMonthlyEconometricIndex,
