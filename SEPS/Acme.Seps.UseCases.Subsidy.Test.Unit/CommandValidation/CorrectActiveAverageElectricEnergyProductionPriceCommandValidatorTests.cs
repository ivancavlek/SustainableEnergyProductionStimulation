...
namespace Acme.Seps.UseCases.Subsidy.Test.Unit.CommandValidation
{
    public class CorrectActiveAverageElectricEnergyProductionPriceCommandValidatorTests
    {
        ...
        public CorrectActiveAverageElectricEnergyProductionPriceCommandValidatorTests()
        {
            _validator = new CorrectActiveAverageElectricEnergyProductionPriceCommandValidator();
        }
